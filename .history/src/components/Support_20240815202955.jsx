    ...
    <div className='w-full h-screen mt-24'>
        ...
        <div className='w-max-w-[1240px] mx-auto text-white relative'>
            <div className='px-4 py-12'>
                ...
                <p className='py-4 text-3xl text-slate-300 text-justify'>With a global community of skilled professionals, we ensure top-notch support and continuous innovation. Join thousands
                 who trust us to elevate their development projects to new heights</p>
            </div>


            <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-12 sm:pt-20'>       
            <div>
                 <div>
                    <PhoneIcon/>
                    <h3>Sales</h3>
