    ...
    <div className='w-full h-screen mt-24'>
        ...
        <div className='w-max-w-[1240px] mx-auto text-white relative'>
            <div className='px-4 py-12'>
                ...
                <p className='py-4 text-3xl yex-center text-slate-300 '>With a global community of skilled professionals, we ensure top-notch support and continuous innovation. Join thousands
