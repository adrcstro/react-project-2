...
transform md:-translate-x-1 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl '>
  <p>Data Services</p>
  <div>
    <p className='flex px-4'><CloudUploadIcon className='h-6'/> App Security</p>
    <p className='flex px-4'><DatabaseIcon className='h-6'/> Dashboard</p>
    <p className='flex px-4'><PaperAirplaneIcon className='h-6'/> Cloud Data</p>
    <p className='flex px-4'><ServerIcon className='h-6'/> API</p>
  </div>
</div>
