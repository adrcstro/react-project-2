...
transform md:-translate-x-1 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl '>
  <p>Data Services</p>
  <div>
    <p className='flex'><CloudUploadIcon className='h-6'/> App Security</p>
    <p className='flex'><DatabaseIcon className='h-6'/> Dashboard</p>
    <p className='flex'><PaperAirplaneIcon className='h-6'/> Cloud Data</p>
    <p className='flex'><ServerIcon className='h-6'/> API</p>
  </div>
</div>
